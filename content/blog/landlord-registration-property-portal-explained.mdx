...
- **Electrical Installation Condition Report (EICR)** — current and satisfactory
- **Energy Performance Certificate (EPC)** — current and meeting the minimum rating
- **Smoke and carbon monoxide alarm compliance** — confirmation that alarms are installed as required
- **Deposit protection details** — which scheme and the certificate reference
...
For diligent landlords, the portal may actually be beneficial. It levels the playing field by ensuring that every landlord meets the same standards, which reduces unfair competition from non-compliant operators and raises the overall reputation of the private rented sector.
