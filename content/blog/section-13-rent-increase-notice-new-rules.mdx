...
From 1 May 2026, the **Section 13 notice** becomes the only lawful route for increasing rent on assured tenancies. Understanding how it works is essential for every private landlord.
...
Under the old framework, most assured shorthold tenancies included a rent review clause that allowed landlords to propose an increase at the end of a fixed term, or at set intervals during the tenancy. If the tenant disagreed, the landlord could simply decline to renew and serve a Section 21 notice.
...
<Callout variant="warning">Rent increases that are significantly above the market rate may be seen as an attempt to force the tenant out. This could constitute unlawful harassment or a retaliatory eviction, both of which carry serious penalties.</Callout>
...
The key is preparation. Understand the process, keep good records of comparable rents, and maintain your property to a standard that justifies the rent you are asking. Landlords who do this will find the new system works perfectly well for them.
