...
<StepList>
<Step number={1}>**Commission a damp and mould survey.** Engage a qualified surveyor to inspect all your rental properties for existing or potential damp and mould issues. This is not the same as an [EPC rating assessment](/blog/epc-rating-requirements-rental-property-2026) or gas safety check — you need someone who understands building pathology and can identify defects that might cause condensation, penetrating damp, or rising damp.</Step>
