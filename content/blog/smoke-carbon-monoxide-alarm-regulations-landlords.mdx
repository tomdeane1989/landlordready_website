...
The rules were strengthened in October 2022, and the requirements are now clearer than ever. If you are not already fully compliant, this guide will tell you exactly what you need to do.
...
However, if a tenant reports that an alarm is faulty, you should replace it promptly. Do not wait until the next tenancy.
...
- **Relying on tenants to report faults.** Include alarm checks in your periodic property inspections
...
Under the Renters' Rights Act 2025, the new Property Portal will require landlords to confirm compliance with smoke and CO alarm regulations. Having a record of your alarm installations, tests, and replacement schedule will make this confirmation straightforward.

Non-compliance with basic safety requirements like alarms will be visible on the portal and will undermine your standing as a compliant landlord. For the sake of a few pounds and a few minutes' work, full compliance is the only sensible approach.
