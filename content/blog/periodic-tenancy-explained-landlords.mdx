...
Under the Renters' Rights Act 2025, all new assured tenancies created after **1 May 2026** will be periodic from the outset. There will be no more fixed-term assured shorthold tenancies. Existing fixed terms that are still running on that date will be allowed to expire naturally, at which point they too become periodic tenancies under the new regime.
...
With no fixed term to anchor a rent review date, rent increases must follow the statutory process set out in **Section 13** of the Housing Act 1988, as reformed by the Renters' Rights Act.
...
Although the tenancy is periodic, the Renters' Rights Act introduces a **12-month protected period** at the start of every tenancy. During this period, landlords cannot use Ground 1 (sale) or Ground 1A (moving in) to seek possession.
...
The key difference is that the framework is now uniform and statutory. Understand it, work within it, and you will continue to operate a successful letting business.
