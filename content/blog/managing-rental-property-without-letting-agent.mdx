...
<Step number={5}>**Protect the deposit.** Register the deposit with a government-approved scheme within 30 days and provide the tenant with the prescribed information.</Step>
...
**Annual requirements:**
- [Gas safety certificate](/blog/gas-safety-certificate-landlord-guide-2026) (every 12 months)
...
The regulatory landscape for private landlords in England changes frequently. The [Renters' Rights Act 2025](/blog/renters-rights-act-2025-what-landlords-need-to-know) is a prime example — staying informed about [key implementation dates](/blog/renters-rights-act-timeline-key-dates) is essential when you do not have an agent monitoring changes on your behalf.
