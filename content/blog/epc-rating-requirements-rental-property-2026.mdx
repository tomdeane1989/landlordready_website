...
Common improvements that boost EPC ratings include loft insulation, cavity wall insulation, upgrading the boiler, installing double glazing, and fitting low-energy lighting throughout.
...
- **Keep records of all work carried out.** You may need to demonstrate improvements for exemption purposes or for the Property Portal
...
Improving your EPC rating protects you from future regulatory changes, reduces void periods, and can justify a fair market rent. It is one of the smartest investments a private landlord can make.
