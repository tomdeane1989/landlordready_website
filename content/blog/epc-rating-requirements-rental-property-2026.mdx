...
<Callout variant="warning">Exemptions must be registered on the PRS Exemptions Register. Simply believing you qualify is not enough — you must formally register the exemption with supporting evidence, and it must be renewed when it expires.</Callout>
