...
The Renters' Rights Act 2025 is not a single event. It is being implemented in phases, with different provisions coming into force at different times. For landlords, understanding this timeline is essential — not just to know what has changed, but to prepare for what is coming next.
...
**Section 21 abolished.** From this date, landlords can no longer serve Section 21 notices. Any Section 21 notice already served but not yet enforced may become invalid — legal advice should be sought on a case-by-case basis.
...
<Step number={2}>**Audit your compliance.** Gas safety, electrical safety, EPC, deposit protection — all must be current. Non-compliance weakens any future possession claim and may attract penalties.</Step>
