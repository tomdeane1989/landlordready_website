...
This guide sets out the key tax obligations for private landlords, the expenses you can legitimately deduct, and the practical steps for filing your self-assessment return correctly.
...
Tax is one area where professional advice almost always pays for itself. A good accountant will ensure you claim all legitimate expenses, structure your affairs efficiently, and avoid costly mistakes. Accountancy fees for rental property are themselves an allowable expense.
